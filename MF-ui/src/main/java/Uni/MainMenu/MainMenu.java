...
import static Uni.MainMenu.MenuDefinitions.HSE_SYS_NOTIF_BOARD;
import static Uni.MainMenu.MenuDefinitions.HSE_WORKPLAN;
import static Uni.MainMenu.MenuDefinitions.MOL_SECTOR_HSE;
import static Uni.MainMenu.MenuDefinitions.MOL_SECTOR_RETAIL;
import static Uni.MainMenu.MenuDefinitions.RETAIL_COCACALC;
import static Uni.MainMenu.MenuDefinitions.RETAIL_COCACALC_DATA_MAINTENENCE;
import static Uni.MainMenu.MenuDefinitions.RETAIL_COCACALC_DATA_MAINTENENCE_CATEGORIES;
import static Uni.MainMenu.MenuDefinitions.RETAIL_COCACALC_DATA_MAINTENENCE_CSR;
import static Uni.MainMenu.MenuDefinitions.RETAIL_COCACALC_PARTNERS_FS;
import static Uni.MainMenu.MenuDefinitions.RETAIL_COCACALC_DATA_MAINTENENCE_KEY_DISTRIBUTION;
import static Uni.MainMenu.MenuDefinitions.RETAIL_COCACALC_DATA_MAINTENENCE_MAPPING;
import static Uni.MainMenu.MenuDefinitions.RETAIL_COCACALC_PARTNERS;
import static Uni.MainMenu.MenuDefinitions.RETAIL_COCACALC_PARTNERS_CONTRACTS;
